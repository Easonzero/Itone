...
public class ChangeLesson extends Activity {
	EditText lessonName;
	EditText location;
	EditText teacher;
	Button confirm;
	...
	private void initDate(){
		...
		weekDay = lessonDates.get(0).weekDay;
		classFrom = lessonDates.get(0).fromClass;
		classTo = lessonDates.get(0).toClass;
		weeks = lessonDates.get(0).weeks;
		old_lessonName = lessonDates.get(0).lessonName;
		old_weekday = lessonDates.get(0).weekDay;
	}
	
	private void initEditText(){
		String[] weekdays = new String[] {"周一", "周二", "周三", "周四", "周五","周六","周日"};
		_classFromTo.setText(weekdays[weekday - 1] +" " + classnum + " - " + lessonDates.get(0).toClass + "节");
		_weekFromTo.setText(lessonDates.get(0).weeknumDelay);
		lessonName.setText(lessonDates.get(0).lessonName);
		location.setText(lessonDates.get(0).classRoom);
		teacher.setText(lessonDates.get(0).teacher);
		classFromTo.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				final PickclassesDialog dialog = new PickclassesDialog(ChangeLesson.this,weekDay,classFrom);
	...
	private void initButton(){
		confirm.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				DBLesson db = new DBLesson(ChangeLesson.this).open();
				db.delete(old_lessonName, old_weekday);
				...
				WatchLesson.watchLesson.finish();
			}
