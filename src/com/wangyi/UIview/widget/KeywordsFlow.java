...
public class KeywordsFlow extends FrameLayout implements OnGlobalLayoutListener {
    ...
    /*
     * keywordsflow的配置在show和hide函数里完成，无需改动其他函数内容
     */
    
    public void showKeywordsFlow(String[] keywords){
		setVisibility(View.VISIBLE);
		setDuration(800l);  
		rubKeywords();  
		feedKeywordsFlow(keywords);   
		go2Show(KeywordsFlow.ANIMATION_OUT);
	}
	
	public void hideKeywordsFlow(){
    ...
    private boolean feedKeyword(String keyword) {  
