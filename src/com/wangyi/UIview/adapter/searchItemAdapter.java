...
public class searchItemAdapter  extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		aq.id(R.id.searchResultTitle).text("第 "+(searchItem.get(position).pageNumber+1)+" 页");
		aq.id(R.id.searchResultDetail).text(searchItem.get(position).searchBoxes.length + " 个结果");
