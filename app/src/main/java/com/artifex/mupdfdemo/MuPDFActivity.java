...
public class MuPDFActivity extends AppCompatActivity implements
        ...
        mSearchTask = new SearchTask(this, core) {
            ...
            protected void onTextFounds(final ArrayList<SearchTaskResult> result) {
                if (popupSearchView != null) {
                    ...
                    view.findViewById(R.id.progressBarSearch).setVisibility(View.GONE);
                    ((TextView)view.findViewById(R.id.searchDetail)).setText(result.size() + " Pages");
    ...
    private void makeButtonsView() {
        ...
        mBottomMenu = (ViewAnimator) mButtonsView.findViewById(R.id.bottomMenus);
            ...
            public boolean onQueryTextSubmit(String query) {
                if (query.length() >= 3) {
                    ...
                    Toast.makeText(getApplicationContext(),
                            "搜索字段过短", Toast.LENGTH_SHORT).show();
                }
                return false;
            }
    ...
    private View createOutlineView(final int showPage) {
        ...
        tabsStrip.setFillViewport(true);
